...
function postJob() {
  ...
  xhr.open('POST', 'https://my-json-server.typicode.com/yyhurs/json-server-db/posts')
...
function delPost(ID) {
  ...
  xhr.open('DELETE', 'https://my-json-server.typicode.com/yyhurs/json-server-db/posts/' + ID)
  xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded')
  xhr.setRequestHeader('User-Agent', 'PostmanRuntime/7.13.0')
  xhr.setRequestHeader('Accept', '*/*')
  xhr.setRequestHeader('Cache-Control', 'no-cache')
...
function editPost(ID) {
  ...
  xhr.open('PATCH', 'https://my-json-server.typicode.com/yyhurs/json-server-db/posts/' + ID)
  xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded')
  xhr.setRequestHeader('User-Agent', 'PostmanRuntime/7.13.0')
  xhr.setRequestHeader('Accept', '*/*')
  xhr.setRequestHeader('Cache-Control', 'no-cache')
